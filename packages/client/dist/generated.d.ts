...
export declare class GeneratedRoutes {
    ...
    registerSource(body: RegisterSourceRequest): Promise<SourceInstance>;
    ...
    listSourceSnapshotMembers(source_ref: string, query?: SourceSnapshotPageRequest): Promise<SourceSnapshotPage>;
