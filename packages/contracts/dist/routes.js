...
export const API_ROUTES = {
    ...
    registerSource: { method: 'POST', path: '/v1/sources', kind: 'json', request: 'RegisterSourceRequestSchema', response: 'SourceInstanceSchema', area: 'administration', authorization: { scopes: ['source:write'] } },
    listSources: { method: 'GET', path: '/v1/sources', kind: 'json', response: 'SourceListSchema', area: 'administration', authorization: { scopes: ['source:read'] } },
    inspectSource: { method: 'GET', path: '/v1/sources/:source_ref', kind: 'json', response: 'SourceInstanceSchema', area: 'administration', authorization: { scopes: ['source:read'] } },
    snapshotSource: { method: 'POST', path: '/v1/sources/:source_ref/snapshots', kind: 'json', response: 'SourceSnapshotSchema', area: 'administration', authorization: { scopes: ['source:write'] } },
    listSourceSnapshotMembers: {
        method: 'GET',
        path: '/v1/sources/:source_ref/snapshot-members',
        kind: 'json',
        query_request: 'SourceSnapshotPageRequestSchema',
        query: [
            { name: 'cursor', type: 'string', minLength: 1, maxLength: 512 },
            { name: 'limit', type: 'integer', minimum: 1, maximum: 100, default: 50 },
        ],
        response: 'SourceSnapshotPageSchema',
        area: 'administration',
        authorization: { scopes: ['source:read'] },
    },
    preflightSource: { method: 'POST', path: '/v1/sources/:source_ref/preflight', kind: 'json', response: 'SourcePreflightSchema', area: 'administration', authorization: { scopes: ['source:read'] } },
